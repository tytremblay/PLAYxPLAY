...
import StreamsTableOldHead from './StreamsTableOldHead';
...
class StreamsTableOld extends PureComponent {
  state = {
    order: 'asc',
    orderBy: 'event_name',
    selected: [],
        ...
        <Card>
          <CardBody>
            <div className="card__title">
              <h5 className="bold-text">Memes</h5>
                    ...
                    .map(d => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="material-table__cell" scope="row" padding="none">
                            {d.id}
                          </TableCell>
                          <TableCell className="material-table__cell" scope="row" padding="none">
                            <Button
